...
@Authors({"mbechler"})
public class JRMPClient_Obj extends PayloadRunner implements ObjectPayload<RemoteObjectInvocationHandler> {
    ...
    public static void main(String[] args) throws Exception {
        Thread.currentThread().setContextClassLoader(JRMPClient_Obj.class.getClassLoader());
        PayloadRunner.run(JRMPClient_Obj.class, args);
    }
}
